package me.matamor.generalapi.api.fanciful;
...
public abstract class TextualComponent implements Cloneable {
	...
	public static TextualComponent objectiveScore(String playerName, String scoreboardObjective) {
		throwUnsupportedSnapshot(); // Remove this line when the feature is released to non-snapshot versions, in addition to updating NONE THE OVERLOADS documentation accordingly
