...
public class Time {
    ...
    public static String toString(long time) {
        ...
        time = appendTime(time, YEAR_MS, "año", timeString);
        time = appendTime(time, DAY_MS, "dia", timeString);
        time = appendTime(time, HOUR_MS, "hora", timeString);
        time = appendTime(time, MINUTE_MS, "minuto", timeString);
        time = appendTime(time, SECOND_MS, "segundo", timeString);
