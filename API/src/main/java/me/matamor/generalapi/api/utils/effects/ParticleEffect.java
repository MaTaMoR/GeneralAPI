package me.matamor.generalapi.api.utils.effects;

import me.matamor.minesoundapi.utils.effects.ReflectionUtils.PackageType;
...
public enum ParticleEffect {
     ...
     * <li>The speed value causes the particle to only move upwards when setActive to 0
     ...
     * <li>The speed value causes the particle to be colored black when setActive to 0
     ...
     * <li>The speed value causes the particle to be always colored black when setActive to 0
     * <li>The particle color gets lighter when increasing the speed and darker when decreasing the speed
     * </ul>
     */
     ...
     * <li>The speed value causes the particle to be colored green when setActive to 0
     * </ul>
     */
     ...
     * <li>The speed value causes the particle to be colored red when setActive to 0
     * </ul>
     */
    ...
    public void display(int i, int i1, int i2, int i3, double lastDamage, Location location, List<Player> playerList, ParticleColor color, Location center, Player... players) throws ParticleVersionException, ParticleColorException {
    ...
    public static final class ParticlePacket {
        ...
        public static void initialize() throws VersionIncompatibleException {
            ...
            try {
                ...
                if (version > 7) enumParticle = PackageType.MINECRAFT_SERVER.getClass("EnumParticle");
